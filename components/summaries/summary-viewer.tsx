...
const SectionTitle = ({ title }: { title: string }) => {
  return (
    ...
    top-0 pt-2 pb-4 bg-background/95 backdrop-blur-xl z-20 border-b border-rose-100/50"
    >
      <h2
        className="text-2xl lg:text-3xl font-bold
      text-center flex items-center justify-center gap-2 text-foreground/80"
      >
        {title}
      </h2>
    </div>
